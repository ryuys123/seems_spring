...
-- 스트레스 검사 문항 추가 (총 10문항)
-- TEST_TYPE: 'PSYCHOLOGICAL_SCALE', CATEGORY: 'STRESS_SCALE', WEIGHT: 1.0, IMAGE_URL: NULL, SCORE_DIRECTION: NULL

INSERT INTO TB_COMMON_QUESTIONS (QUESTION_ID, TEST_TYPE, QUESTION_TEXT, IMAGE_URL, WEIGHT, CATEGORY, SCORE_DIRECTION)
VALUES (53, 'PSYCHOLOGICAL_SCALE', '지난 한 달 동안, 예상치 못한 일 때문에 안절부절못한 적이 있었습니까?', NULL, 1.0, 'STRESS_SCALE', NULL);

INSERT INTO TB_COMMON_QUESTIONS (QUESTION_ID, TEST_TYPE, QUESTION_TEXT, IMAGE_URL, WEIGHT, CATEGORY, SCORE_DIRECTION)
VALUES (54, 'PSYCHOLOGICAL_SCALE', '지난 한 달 동안, 중요한 일들을 통제할 수 없다고 느낀 적이 있었습니까?', NULL, 1.0, 'STRESS_SCALE', NULL);

INSERT INTO TB_COMMON_QUESTIONS (QUESTION_ID, TEST_TYPE, QUESTION_TEXT, IMAGE_URL, WEIGHT, CATEGORY, SCORE_DIRECTION)
VALUES (55, 'PSYCHOLOGICAL_SCALE', '지난 한 달 동안, 신경이 예민해지고 스트레스를 받아서 짜증이 났던 적이 있었습니까?', NULL, 1.0, 'STRESS_SCALE', NULL);

INSERT INTO TB_COMMON_QUESTIONS (QUESTION_ID, TEST_TYPE, QUESTION_TEXT, IMAGE_URL, WEIGHT, CATEGORY, SCORE_DIRECTION)
VALUES (56, 'PSYCHOLOGICAL_SCALE', '지난 한 달 동안, 자신의 개인적인 문제들을 성공적으로 다룰 수 있다고 느낀 적이 있었습니까?', NULL, 1.0, 'STRESS_SCALE', NULL);

INSERT INTO TB_COMMON_QUESTIONS (QUESTION_ID, TEST_TYPE, QUESTION_TEXT, IMAGE_URL, WEIGHT, CATEGORY, SCORE_DIRECTION)
VALUES (57, 'PSYCHOLOGICAL_SCALE', '지난 한 달 동안, 당신이 해야 할 모든 일들을 성공적으로 처리할 수 있다고 확신한 적이 있었습니까?', NULL, 1.0, 'STRESS_SCALE', NULL);

INSERT INTO TB_COMMON_QUESTIONS (QUESTION_ID, TEST_TYPE, QUESTION_TEXT, IMAGE_URL, WEIGHT, CATEGORY, SCORE_DIRECTION)
VALUES (58, 'PSYCHOLOGICAL_SCALE', '지난 한 달 동안, 짜증나는 일들을 통제할 수 없다고 느낀 적이 있었습니까?', NULL, 1.0, 'STRESS_SCALE', NULL);

INSERT INTO TB_COMMON_QUESTIONS (QUESTION_ID, TEST_TYPE, QUESTION_TEXT, IMAGE_URL, WEIGHT, CATEGORY, SCORE_DIRECTION)
VALUES (59, 'PSYCHOLOGICAL_SCALE', '지난 한 달 동안, 당신의 방식대로 일들이 진행되지 않아 화가 난 적이 있었습니까?', NULL, 1.0, 'STRESS_SCALE', NULL);

INSERT INTO TB_COMMON_QUESTIONS (QUESTION_ID, TEST_TYPE, QUESTION_TEXT, IMAGE_URL, WEIGHT, CATEGORY, SCORE_DIRECTION)
VALUES (60, 'PSYCHOLOGICAL_SCALE', '지난 한 달 동안, 해야 할 일들이 너무 많아 감당하기 어렵다고 느낀 적이 있었습니까?', NULL, 1.0, 'STRESS_SCALE', NULL);

INSERT INTO TB_COMMON_QUESTIONS (QUESTION_ID, TEST_TYPE, QUESTION_TEXT, IMAGE_URL, WEIGHT, CATEGORY, SCORE_DIRECTION)
VALUES (61, 'PSYCHOLOGICAL_SCALE', '지난 한 달 동안, 어려움이 닥쳐올 때 그것을 통제할 수 있다고 느낀 적이 있었습니까?', NULL, 1.0, 'STRESS_SCALE', NULL);

INSERT INTO TB_COMMON_QUESTIONS (QUESTION_ID, TEST_TYPE, QUESTION_TEXT, IMAGE_URL, WEIGHT, CATEGORY, SCORE_DIRECTION)
VALUES (62, 'PSYCHOLOGICAL_SCALE', '지난 한 달 동안, 사소한 일들에 대해 계속해서 걱정한 적이 있었습니까?', NULL, 1.0, 'STRESS_SCALE', NULL);
...
-- 1. 로맨스 시나리오
INSERT INTO TB_SIMULATION_SCENARIOS (
    SCENARIO_ID,
    SCENARIO_NAME,
    DESCRIPTION,
    IS_ACTIVE,
    CREATED_AT
             ...
             SCENARIO_SEQ.NEXTVAL, -- SCENARIO_SEQ 시퀀스를 사용하여 ID 자동 생성
             '로맨스',
             '설레는 만남과 감정의 파동 속에서 당신의 선택은? 공감능력, 감정표현, 신뢰, 배려와 같은 관계 중심의 성향을 분석합니다.',
             1,
             SYSDATE
         );
...
INSERT INTO TB_SIMULATION_SCENARIOS (
    ...
    CREATED_AT
             ...
             SCENARIO_SEQ.NEXTVAL,
             '판타지',
             '마법과 모험, 상상력의 세계에서 펼쳐지는 이야기. 상상력, 모험심, 창의성, 용기와 같은 도전 중심의 성향을 분석합니다.',
             1,
             SYSDATE
         );
...
INSERT INTO TB_SIMULATION_SCENARIOS (
    ...
    CREATED_AT
             ...
             SCENARIO_SEQ.NEXTVAL,
             '공포',
             '두려움과 긴장, 미지의 공포에 맞서는 당신의 심리. 용기, 침착함, 위기대처, 공포극복과 같은 위기 대응 성향을 분석합니다.',
             1,
             SYSDATE
         );
...
INSERT INTO TB_SIMULATION_SCENARIOS (
    ...
    CREATED_AT
             ...
             SCENARIO_SEQ.NEXTVAL,
             '액션',
             '위기와 도전, 빠른 판단이 필요한 순간의 연속. 결단력, 추진력, 리더십, 위험감수와 같은 행동 중심의 성향을 분석합니다.',
             1,
             SYSDATE
         );
...
--    SCENARIO_SEQ.NEXTVAL,
--    '코미디',
--    '유쾌함과 재치, 웃음 속에서 드러나는 당신의 매력. 유머감각, 긍정성, 융통성, 소통능력과 같은 사회적 상호작용 성향을 분석합니다.',
--    1,
--    SYSDATE
--);

COMMIT; -- 변경사항을 데이터베이스에 최종 반영합니다.
...
INSERT INTO TB_QUEST (QUEST_ID, USER_ID, QUEST_NAME, QUEST_POINTS, IS_COMPLETED, CREATED_AT)
VALUES (SEQ_QUEST_QUEST_ID.NEXTVAL, 'user002', '첫 상담 시작하기', 25, 1, TO_DATE('2025-01-12', 'YYYY-MM-DD'));

INSERT INTO TB_QUEST (QUEST_ID, USER_ID, QUEST_NAME, QUEST_POINTS, IS_COMPLETED, CREATED_AT)
VALUES (SEQ_QUEST_QUEST_ID.NEXTVAL, 'user002', '감정 분석 리포트 확인하기', 15, 0, TO_DATE('2025-01-14', 'YYYY-MM-DD'));

INSERT INTO TB_QUEST (QUEST_ID, USER_ID, QUEST_NAME, QUEST_POINTS, IS_COMPLETED, CREATED_AT)
VALUES (SEQ_QUEST_QUEST_ID.NEXTVAL, 'user002', '시뮬레이션 테스트 완료하기', 30, 0, TO_DATE('2025-01-16', 'YYYY-MM-DD'));

INSERT INTO TB_QUEST (QUEST_ID, USER_ID, QUEST_NAME, QUEST_POINTS, IS_COMPLETED, CREATED_AT)
VALUES (SEQ_QUEST_QUEST_ID.NEXTVAL, 'user002', '일일 퀘스트 3개 완료하기', 20, 0, TO_DATE('2025-01-17', 'YYYY-MM-DD'));
