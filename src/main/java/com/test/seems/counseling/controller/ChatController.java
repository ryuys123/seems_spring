...
public class ChatController {
    ...
    public ResponseEntity<Map<String, Object>> chatWithAI(@RequestBody Map<String, Object> requestBody) {
        List<Map<String, String>> messages = (List<Map<String, String>>) requestBody.get("messages");
        Integer currentCoreQuestionIndex = (Integer) requestBody.get("current_core_question_index");
