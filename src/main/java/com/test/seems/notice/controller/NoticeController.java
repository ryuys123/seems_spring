...
public class NoticeController {
	...
	// select 쿼리 실행 요청임 => 전송방식은 GET 임 => @GetMapping 으로 지정해야 함
	// ArrayList 만 반환하면 목록페이지의 pagingView 에 사용할 paging 객체 정보가 없어서 페이지 출력 안됨
//	@GetMapping("/notice")
...
//	}
	...
	public ResponseEntity<String> noticeUpdateMethod(
			@PathVariable int noticeNo,
			@ModelAttribute Notice notice, HttpServletRequest request,
